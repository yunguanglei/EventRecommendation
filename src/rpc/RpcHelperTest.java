...
public class RpcHelperTest {
	...
	public void testGetJSONArray() throws JSONException {
		...
		Item one = new ItemBuilder().setItemId("one").setName("lei").setRating(5).setCategories(category).setAddress("home").setDistance(15).setImageUrl(null).setUrl(null).build();
		Item two = new ItemBuilder().setItemId("two").setName("Lei").setRating(5).setCategories(category).setAddress("home").setDistance(15).setImageUrl(null).setUrl(null).build();
